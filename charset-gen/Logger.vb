...
#Region "Windows Form Designer generated code "
        ...
        <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
            ...
            Me.rtbLog.Anchor = (((System.Windows.Forms.AnchorStyles.Top Or System.Windows.Forms.AnchorStyles.Bottom) _
            ...
            'chkMinor
            '
            Me.chkMinor.Anchor = (System.Windows.Forms.AnchorStyles.Top Or System.Windows.Forms.AnchorStyles.Right)
            ...
            'optAll
            '
            Me.optAll.Anchor = (System.Windows.Forms.AnchorStyles.Bottom Or System.Windows.Forms.AnchorStyles.Right)
            ...
            'lblDisplay
            '
            Me.lblDisplay.Anchor = (System.Windows.Forms.AnchorStyles.Top Or System.Windows.Forms.AnchorStyles.Right)
            ...
            'chkMajor
            '
            Me.chkMajor.Anchor = (System.Windows.Forms.AnchorStyles.Top Or System.Windows.Forms.AnchorStyles.Right)
            ...
            'chkLifetime
            '
            Me.chkLifetime.Anchor = (System.Windows.Forms.AnchorStyles.Top Or System.Windows.Forms.AnchorStyles.Right)
            ...
            'chkError
            '
            Me.chkError.Anchor = (System.Windows.Forms.AnchorStyles.Top Or System.Windows.Forms.AnchorStyles.Right)
            ...
            'chkWarning
            '
            Me.chkWarning.Anchor = (System.Windows.Forms.AnchorStyles.Top Or System.Windows.Forms.AnchorStyles.Right)
            ...
            'optTen
            '
            Me.optTen.Anchor = (System.Windows.Forms.AnchorStyles.Bottom Or System.Windows.Forms.AnchorStyles.Right)
            ...
            'optFive
            '
            Me.optFive.Anchor = (System.Windows.Forms.AnchorStyles.Bottom Or System.Windows.Forms.AnchorStyles.Right)
            ...
            'optTwo
            '
            Me.optTwo.Anchor = (System.Windows.Forms.AnchorStyles.Bottom Or System.Windows.Forms.AnchorStyles.Right)
            ...
            'optOne
            '
            Me.optOne.Anchor = (System.Windows.Forms.AnchorStyles.Bottom Or System.Windows.Forms.AnchorStyles.Right)
            ...
            'lblDisplayApps
            '
            Me.lblDisplayApps.Anchor = (System.Windows.Forms.AnchorStyles.Bottom Or System.Windows.Forms.AnchorStyles.Right)
            ...
            Me.Controls.AddRange(New System.Windows.Forms.Control() {Me.optOne, Me.optTwo, Me.optFive, Me.optTen, Me.lblDisplayApps, Me.chkWarning, Me.chkError, Me.chkLifetime, Me.chkMajor, Me.lblDisplay, Me.optAll, Me.chkMinor, Me.rtbLog, Me.btnRefresh, Me.btnOK})
...
#End Region
        ...
        Private Sub btnRefresh_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnRefresh.Click
            ...
            If optAll.Checked Then
                intInstances = 0
            End If
            rtbLog.Text = Log.GetTextDisplay(intInstances, chkMinor.Checked, chkMajor.Checked, chkLifetime.Checked, chkError.Checked, chkWarning.Checked)
        End Sub
        ...
        Private Sub LogViewer_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load


        End Sub

        Private Sub lblDisplayApps_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles lblDisplayApps.Click

        End Sub

        Private Sub optTwo_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        Private Sub LogViewer_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
...
#Region "Event Log Register Variables"
        ...
        Private m_strSource As String = Application.ProductName
...
#Region "Logging Entry Variables"
        ...
        Private m_strAppStartEntry As String = _
                "+Starting " & Application.ProductName & "..."

        'Entry to add when LogAppEnd is called and m_blnLifetime is true
        Private m_strAppEndEntry As String = "-Ending " & Application.ProductName & "..."

        'File to log to if m_blnFileLogging is true
        Private m_strLogFile As String = "Debug.txt"

        'Directory logging file is stored in
        Private m_strLogDir As String = System.IO.Path.GetDirectoryName(Application.ExecutablePath)
        ...
        Public Property LogToEventLog() As Boolean
            ...
            Set(ByVal Value As Boolean)
                ...
                If Value Then
                    ...
                    If Not EventLog.SourceExists(m_strSource) Then

                        If EventLog.Exists(m_strLogName.Substring(0, 9)) Then
                            EventLog.Delete(m_strLogName.Substring(0, 9))
                        Else
                            EventLog.CreateEventSource(m_strSource, m_strLogName)
                        End If
                    Else
...
#Region "Entry Logging Routines"
        ...
        Public Overloads Sub LogAppStart(Optional ByVal StartString As String = "")
            ...
            Dim m_strStartData As String = cm_strLifetimeAppTitleHeader & Application.ProductName & _
                                               cm_strLifetimeAppTitleEnder & cm_strSectionSeparator & _
                                               cm_strLifetimeAppEXEHeader & Application.ExecutablePath & _
        ...
        Public Overloads Sub LogAppEnd(Optional ByVal EndString As String = "")
            ...
            Dim m_strEndData As String = cm_strLifetimeAppTitleHeader & Application.ProductName & _
                                   cm_strLifetimeAppTitleEnder & cm_strSectionSeparator & _
                                   cm_strLifetimeAppEXEHeader & Application.ExecutablePath & _
                                   cm_strLifetimeAppEXEEnder & cm_strSectionSeparator & cm_strLifetimeAppVersionHeader & _
                                   Application.ProductVersion & _
            ...
            If m_blnFileLogging Then
                If System.IO.File.Exists(m_strLogDir + System.IO.Path.DirectorySeparatorChar + m_strLogFile) Then
                    ...
                    Do Until intCurrentEndEntry >= strFile.Length - cm_strEntryHeader.Length
                        ...
                        Do Until strFile.Substring(intStartEntry, Log.cm_strEntryHeader.Length) = cm_strEntryHeader Or intStartEntry >= strFile.Length - cm_strEntryHeader.Length
                            intStartEntry += 1
                        Loop
                        ...
                        If intEndEntry < strFile.Length - cm_strEntryHeader.Length Then
                            ...
                            Do Until strFile.Substring(intEndEntry, Log.cm_strEntryHeader.Length) = cm_strEntryHeader Or intEndEntry >= strFile.Length - cm_strEntryHeader.Length
                                intEndEntry += 1
                            Loop
                            If intEndEntry >= strFile.Length - cm_strEntryHeader.Length Then
